import { PRIVATE, PUBLIC, GOING, INTERESTED, IGNORE } from '@/assets/constants'
    ...
    attendance: {
      membersAccess: {
        list: [
          ...
          { id: 890, firstName: "Isaiah", status: IGNORE, invited: false},
          { id: 67, firstName: "Mark", status: INTERESTED, invited: false},
          { id: 836, firstName: "Dollie", status: IGNORE, invited: false},
